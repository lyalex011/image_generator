          ...
          <section className="mb-8 ">
            <div className="grid  gap-4 md:grid-cols-2">
              ...
              <h2 className="mb-6 text-3xl font-bold">Frequently asked questions</h2>
                ...
                All images on this website are from <a className="text-blue-600 dark:text-blue-500 hover:underline" href="https://unsplash.com/license">Unsplash.com</a>. Their licence grants you an irrevocable, nonexclusive, worldwide copyright license to download, copy, modify, distribute, perform, and use photos from Unsplash for free, including for commercial purposes, without permission from or attributing the photographer or Unsplash. This license does not include the right to compile photos from Unsplash to replicate a similar or competing service.
                </p>
